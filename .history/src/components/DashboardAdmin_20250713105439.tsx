...
import { fetchTotalRevenue, RevenueData } from "../redux/slices/revenueSlice";
...
// Sửa phần khai báo kiểu dữ liệu
...
export default function DashboardAdmin() {
	...
	const { data: dataRevenue } = useSelector<RootState, { data: RevenueData | null }>(
		(state) => state.revenue
	);
